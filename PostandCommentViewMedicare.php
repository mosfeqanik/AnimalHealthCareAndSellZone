...
<div class="posts">
    <div class="container">
                <?php
                    foreach ($allPostsAndComment as $singlePostandComment) {
                        ?>
                        <div class="row">
                            <div class="col-md-10 blogShort">
                                <h1>post :
                                    <?php
                                        $singlePostandComment['post_id'];
                                        echo $singlePostandComment['comments_id'];
                                        $post_id=$singlePostandComment['post_id'];
//                                        echo $id;
                                        $posts = $postandCommentdata->ShowPostById($post_id);
                            ...
                            <div class="col-lg-1">
                                <p><?php
                                        echo $singlePostandComment['comment'];
                                    ?>
                                </p>
                                <a href="delete.php?id=<?php  echo $singlePostandComment['comments_id'];?>">
                                    <button class="btn pull-right marginBottom10 btn-danger">
                                        Delete
                                    </button>
                                </a>
                            </div>
