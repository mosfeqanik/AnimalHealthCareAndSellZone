...
<div class="jumbotron text-center">
    <h1>SEE YOUR CowS INFORMATION</h1>
    <p>Please input your Cows Age to see Nutrition</p>
</div>

<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <div align="center" style="border: 1px solid white" >    <h3>Cow</h3>
                <img src="images/cow2.jpg" class="img-responsive" alt="Cow" style="width: 600px;height: 450px" />
                <p>Please Enter Your Cows Age and Weight for knowing Body Condition (Out of 5) and Calories! </p>
                <form name="formc">
                    <p>Age</p>
                    ...
                    <input type="button" value="See Body Condition and needed Calories" onclick="Cowscore()"></br></br>
