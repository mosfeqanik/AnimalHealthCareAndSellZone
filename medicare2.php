...
<div class="posts">
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="post-title" ><strong><?php echo $post['Symptoms']; ?></strong></h4>
                        </div>
                    </div>
                ...
                <textarea id="Comment" name="Comment" placeholder="Write a Comment.." style="height:200px"></textarea>
