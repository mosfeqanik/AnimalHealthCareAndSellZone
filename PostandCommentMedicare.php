...
$postdata= new Database();
$allposts=$postdata->readpostdata();
?>
...
<!-- //gallery -->
    <div class="posts">
        <div class="container">
                    ...
                    ?>
                     <form action="commentCreated.php" method="post">
                        <div class="row">
                        ...
                        <div class="col-lg-1">
                            <textarea id="Comment" name="comment" placeholder="Write a Comment.."
                                      style="width: 250px;height: 100px;"></textarea>
                            <button name="submit" type="submit" class="btn btn-blog pull-right marginBottom10">submit</button>
                        </div>
                     </div>
                     </form>
                     <?php
